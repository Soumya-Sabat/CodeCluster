...
export default function Hero() {
  ...
  return (
    <section className="relative pt-10 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      {/* Background Glows */}
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
            <Link 
            href="/register"
            className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3 rounded-xl transition-all flex items-center justify-center gap-2 group shadow-lg shadow-indigo-600/20">
              Start with Us
              <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Link>
            <button 
            onClick={() => router.push('/onboarding')}
            className="w-full sm:w-auto bg-slate-800/80 hover:bg-slate-800 text-slate-200 border border-slate-700/60 font-semibold px-6 py-3 rounded-xl transition-colors">
              Explore Clusters
            </button>
          </div>

          {/* Micro Stats */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs font-medium text-slate-400 border-t border-slate-800/60 pt-2">
        ...
        <div className="lg:col-span-5 flex justify-center items-center w-full min-h-[350px] lg:min-h-[450px]">
          ...
          <div className="w-full h-full border border-dashed border-slate-800 rounded-2xl flex items-center justify-center bg-slate-900/20 text-slate-600 text-sm italic p-8">
            <img src="/images/heroimage.png" alt="HeroSectionImage" />
          </div>
        </div>
      </div>
    </section>
